...
namespace CloudAE.Core.Delaunay
{
    public class Triad
    {
        ...
        public void Initialize(int a, int b, int c, int ab, int bc, int ac, Vertex[] points)
        {
            this.a = a;
            this.b = b;
            this.c = c;
        ...
        /// </summary>
        public void MakeClockwise(Vertex[] points)
        {
        ...
        /// </summary>
        public bool FindCircumcirclePrecisely(Vertex[] points)
        {
